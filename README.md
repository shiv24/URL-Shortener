...
**_1. Setting a short url for a long url. The following curl returns a short url._**
...
**_2. Getting a long url from a short url_**
...
**_3. Getting the analytics of a short url (how many times it was accessed in the last 24 hours, week, and all time)_**
